<div class="my-4">
    ...
    <div class="border-b border-gray-200 pb-5">
        <h3 class="text-lg font-medium leading-6 text-gray-900">All Participants</h3>
        <p class="mt-2 max-w-4xl text-sm text-gray-500">All the participants registerd for each events are listed
